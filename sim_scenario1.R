...
c <- 0.9914 
d <- 0.7282 
a <- -0.5141   # MA part negated to be consistent with +signs in the filter defn.
...
save.image(file = "simTBATS_AP_1.RData")
...
save(errPATBATS_sim2,file = "simTBATS_PA_1")

# Errors  
#load("simTBATS_AP_1.RData")
#load("simTBATS_PA_1")
